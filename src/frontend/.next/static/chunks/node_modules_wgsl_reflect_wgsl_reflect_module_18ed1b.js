(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/node_modules_wgsl_reflect_wgsl_reflect_module_18ed1b.js", {
...
__turbopack_esm__({
    ...
    "WgslScanner": (()=>WgslScanner),
    "While": (()=>While),
    "_BlockEnd": (()=>_BlockEnd),
    "_BlockStart": (()=>_BlockStart)
});
class ParseContext {
    constructor(){
...
class WgslParser {
    ...
    _switch_body() {
        ...
        if (this._check([
            TokenTypes.keywords.default,
            TokenTypes.keywords.case
        ])) {
    ...
    _equality_expression() {
        ...
        if (this._match([
            TokenTypes.tokens.equal_equal,
            TokenTypes.tokens.not_equal
        ])) {
    ...
    _shift_expression() {
        ...
        while(this._match([
            TokenTypes.tokens.shift_left,
            TokenTypes.tokens.shift_right
        ])){
    ...
    _struct_decl() {
        ...
        while(!this._check(TokenTypes.tokens.brace_right)){
            ...
            if (!this._check(TokenTypes.tokens.brace_right)) this._consume(TokenTypes.tokens.comma, "Expected ',' for struct member.");
    ...
    _requires_directive() {
        ...
        const extensions = [
            this._consume(TokenTypes.tokens.ident, "identity expected.").toString()
        ];
        while(this._match(TokenTypes.tokens.comma)){
            const name = this._consume(TokenTypes.tokens.ident, "identity expected.");
    ...
    _type_decl() {
        ...
        if (this._match(TokenTypes.keywords.array)) {
            ...
            if (countNode) {
                this._deferArrayCountEval.push({
                    arrayType,
                    countNode
                });
            }
...
//# sourceMappingURL=node_modules_wgsl_reflect_wgsl_reflect_module_18ed1b.js.map